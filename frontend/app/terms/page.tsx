      ...
      >
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          <section>
            ...
            >
              By accessing and using StudyIntel (&quot;the Service&quot;), you
          ...
          <section>
            ...
            <p
              ...
              style={{ color: "var(--text-secondary)" }}
            >
              StudyIntel is a platform designed to help students organize their
              study sessions, track academic progress, and collaborate with
              peers. The service includes features such as study session
              logging, progress tracking, event management, and collaborative
              tools.
            </p>
          </section>
          ...
          <section>
            ...
            >
              <p>
                To access certain features of StudyIntel, you must sign up for
                an account. When creating your account, you agree to:
              </p>
          ...
          <section>
            ...
            >
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li>
                  Share academic work in ways that violate academic integrity
                  policies
                </li>
              </ul>
            </div>
          ...
          <section>
            ...
            >
              ...
              service. By using StudyIntel, you agree to the collection and use
          ...
          <section>
            ...
            >
              <p>
                StudyIntel and its original content, features, and functionality
              ...
              <p>
                ...
                on StudyIntel. By submitting content, you grant us a worldwide,
                non-exclusive, royalty-free license to use, reproduce, and
                distribute such content solely for the purpose of providing the
                service.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p
              ...
              style={{ color: "var(--text-secondary)" }}
            >
              StudyIntel is designed to support legitimate academic activities.
              Users are responsible for ensuring their use of the platform
              complies with their institution&apos;s academic integrity
              policies. We do not condone or support academic dishonesty in any
              form.
            </p>
          </section>
          ...
          <section>
            ...
            <p
              ...
              style={{ color: "var(--text-secondary)" }}
            >
              We strive to maintain StudyIntel&apos;s availability but cannot
          ...
          <section>
            ...
            <p
              ...
              style={{ color: "var(--text-secondary)" }}
            >
              StudyIntel is provided &quot;as is&quot; without warranties of any
              kind. We shall not be liable for any indirect, incidental,
              special, consequential, or punitive damages, including without
              limitation, loss of profits, data, use, or other intangible losses
